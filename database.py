...
class Database:
	...
	def insert_query_log(self, lhash, qtype, text, search, qhash, ip, browser, qneg, lang): 	
		sql = "INSERT INTO log_query (log_hash, query_type, query_text, query_search, query_hash, query_negation, query_time, client_ip, client_browser, language, clicked) VALUES" + \
					"(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
		self.cur.execute(sql, (lhash, qtype, text, search, qhash, qneg, datetime.now(), ip, browser, lang, 0))
		self.conn.commit()
